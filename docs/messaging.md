...
`docs/foundation.md` (v1.2) and `docs/audience.md`.**

`docs/foundation.md` stays canonical; where this document restates a foundation
ruling, the foundation wins. This document is the reusable messaging contract for
Phase 3 (IA/sitemap) and Phase 4 (execution). It is not final page copy and not
information architecture. Anything marked **[VALIDATION-NEEDED]** is canonical
direction awaiting Crystelle's sign-off and must not ship as frozen public copy.

---

## 1. Core messaging strategy

Every message on the site answers one buyer question, in a segment-specific form:

| Segment | The live question |
|---|---|
| Private clients | « Est-ce que je peux faire confiance à son œil ? » |
| B2B | "Can this studio carry a fit-out without surprises on budget and délais?" |
| Art visitors | "Is this place for someone like me?" |
| Artists | "Is this venue serious?" |

The strategy that answers them, in priority order:

1. **Trust through proof, not assertion.** The audience evidence is unambiguous:
   « à l'écoute » is the universal praise currency, and credentials qualify while
   references persuade. So écoute, budget respect, and transformation are *proof
   themes* delivered through testimonials, case studies, and process description.
   They are never claimed as slogans ("nous sommes à votre écoute" is banned as a
   self-description; a client saying it is the whole point).
...
*a qualified architecte d'intérieur with 30 years of craft, who listens and
respects your budget, working from Jukkai, a colourful place in Châteaugiron
where the same eye chooses artworks and designs spaces.* The bridge clause is
vision framing only (foundation §10): never past tense, never track record,
until a first documented placement exists.

## 2. The two registers

The site speaks two registers. Both live inside the five closed tone axes (warm
but not soft, colourful but not loud, accessible but not cheap, expert but not
academic, rock but not punk); they weight the axes differently.
...
- **Grammar**: concrete nouns, numbers, commitments. Budget, délais, phases,
  honoraires. Short declarative sentences. The client's project is the subject
  of the sentence more often than the studio is.
- **CTA territory**: warm invitation to talk, « Parlons de votre projet »
  register, sitewide primary.
...
- **Moves**: describe the scene sensorially (you push the door, colour, art on
  the walls, sculptures on columns, the architects at work behind the vitrines,
  someone offers you a coffee), give coup-de-cœur permission (« adepte ou
  néophyte »), invite rather than sell. « Démocratiser l'art » is expressed
  through scene and behaviour, never as a slogan.
- **Grammar**: present tense, second person, sensory and specific. No art-world
  jargon, no claims that require proof, no superlatives.
- **CTA territory**: « venez pousser la porte » register (visit, follow,
  newsletter), always secondary weight.

The philosophy line « Chaque contrainte est un terrain de jeu » belongs to both
registers: it is the one sentence where the architect's rigour and the Jukkai
...
### 4.1 Private architecture clients (primary)

- **Core message**: an architecte d'intérieur you can trust with your home and
  your budget: she listens, she makes you see the result before you commit, and
  the mission is clear before any paid work begins.
- **Lead with**: écoute and projection. The screening criterion is "will she
  respect our tastes or style at us?"; testimonials and case-study copy must
  carry the « à l'écoute », « respecté nos goûts et envies », « des idées
  auxquelles nous n'aurions jamais pensé seuls » register.
...
- **Lead with**: process and references, not credentials and not QVT clichés.
  The documented local differentiation gap: most Rennes providers pitch
  QVT/productivité boilerplate; the credible move is process made visible
  (cahier des charges intake, phases, artisan coordination) plus named tertiary
  references with surface and place (the "500 m² plateau" shape). References are
...
professionnels; contrat de mission / lettre de mission; honoraires; suivi de
chantier.

**Client-language register (from evidence; use in copy and let testimonials say
it):** à l'écoute; se projeter; optimiser l'espace; « par quoi commencer »;
respecter le budget; des idées auxquelles vous n'auriez pas pensé; transformé;
le résultat; avec du goût.

**B2B register:** aménagement de bureaux; espaces tertiaires; plateau de
bureaux; cahier des charges; respect des délais et du budget; un seul
interlocuteur; relai auprès des artisans.

**Jukkai register:** venez pousser la porte; coup de cœur; craquer pour;
dénicher; adepte ou néophyte; démocratiser l'art (behaviour, not slogan);
...
- « prix disponible sur demande », or any wording that makes price a privilege
  to request. The enemy phrase of the art segment.
- « premium », « haut de gamme », « luxe » as public copy. Premium inversion is
  an internal frame; the public words are « l'exigence d'une architecte
  d'intérieur ». Accessible but not cheap also means not performatively
  expensive.
- « décoratrice » as an identity label for Crystelle or the studio. « Déco »
  appears only as mission vocabulary under the architecte d'intérieur identity.
- Self-asserted proof themes: « nous sommes à l'écoute », « nous respectons
  votre budget » as claims in the studio's own voice. Show them through client
  words and process facts.
- QVT / « bien-être des collaborateurs » boilerplate on the B2B page. The
...
## 9. French public-language guidance

**Fixed and canonical (use as-is):**
...
**Default proposed by this phase (adopt unless overruled):** vouvoiement
sitewide, in both registers. All evidence language (reviews, market copy, the
CTA registers) is vous-based, and warm-but-not-soft supports it. A tutoiement
...
copy must be spot-checked at source first; client testimonials additionally need
...
5. **Art prices: none, anywhere, pre-opening.** And never the « prix sur
   ...
   specific; the two rules are different on purpose.
6. **Bridge claims are vision-tense.** « Le même œil choisit les œuvres et
   dessine les espaces » and variants; no past tense, no track-record framing,
   until a documented placement exists.
